...
#   cdk deploy --context github_owner=armakuni --context github_repo=ak-aws-access-vending
...
secrets = SecretsStack(app, "ak-aws-access-vending-secrets", env=env)

# 2. DynamoDB tables
dynamodb = DynamoDBStack(app, "ak-aws-access-vending-dynamodb", env=env)

# 3. CodePipeline: creates ECR repo + builds/pushes Docker image on every push
pipeline = PipelineStack(
    app,
    "ak-aws-access-vending-pipeline",
...
apprunner = AppRunnerStack(
    app,
    "ak-aws-access-vending-apprunner",
